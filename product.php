			...
			<div class="col-lg-6" id="sidebar-fixed">
				<div class="breadcrumbs">
					<ul>
						...
						<?php } elseif ($row['categoryID'] <= 8) { ?>
						<li><a type="button"><?php echo $classes[2]['className']; ?></a></li>
						<?php } elseif ($row['categoryID'] <= 12) { ?>
...
?>
        ...
        if (($_COOKIE['CURRENCY'] == 'EUR') && (isset($_SESSION['MURtoEUR']))) {
            ...
            echo '₦' . number_format($row['newPrice'] * $_SESSION['MURtoNGN']);
        } else {
            echo 'Rs ' . number_format($row['newPrice']);
								...
								<?php
								    if (($_COOKIE['CURRENCY'] == 'EUR') && (isset($_SESSION['MURtoEUR']))) {
								        ...
								        echo '₦' . number_format($row['oldPrice'] * $_SESSION['MURtoNGN']);
								    } else {
        ...
        if ($row['collectionID'] == 1) {
            ?>
								...
								<?php } elseif ($row['collectionID'] == 3) { ?>
								<span class="best-flag"><?php echo 'Best Selling'; ?></span>
								<?php } elseif ($row['collectionID'] == 4) { ?>
...
for ($i = 0; $i < 6; $i++) {
    if ($related[$i]['collectionID'] == 1) {
			...
			<div class="item">
				<div class="grid-item">
                    ...
                    if (($_COOKIE['CURRENCY'] == 'EUR') && (isset($_SESSION['MURtoEUR']))) {
                        ...
                        echo '₦' . number_format($related[$i]['newPrice'] * $_SESSION['MURtoNGN']);
                    } else {
        ...
        ?>
			...
			<?php	} elseif ($related[$i]['collectionID'] == 2) { ?>
			<div class="item">
				<div class="grid-item">
					<figure>
        ...
        if (($_COOKIE['CURRENCY'] == 'EUR') && (isset($_SESSION['MURtoEUR']))) {
            ...
            echo 'Rs ' . number_format($related[$i]['newPrice']);
			    ...
			    if (($_COOKIE['CURRENCY'] == 'EUR') && (isset($_SESSION['MURtoEUR']))) {
			        ...
			        echo '₦' . number_format(($related[$i]['oldPrice']) * $_SESSION['MURtoNGN']);
			    } else {
			...
			<?php	} elseif ($related[$i]['collectionID'] == 3) { ?>
			<div class="item">
				<div class="grid-item">
					<figure>
			...
			<?php	} elseif ($related[$i]['collectionID'] == 4) { ?>
			<div class="item">
				<div class="grid-item">
					<figure>
