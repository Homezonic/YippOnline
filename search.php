				...
				<div class="filter-col">
					...
					<div class="filter-type abhijeet">
						...
						<div class="collapse show" id="filter-2">
							<ul>
								<li>
									<label class="container-check">0 - 1,000<small>6</small>
									<input type="checkbox" checked>
									<span class="checkmark"></span>
									</label>
								</li>
								<li>
									<label class="container-check">1,000 - 10,000<small>12</small>
									<input type="checkbox" checked>
									<span class="checkmark"></span>
									</label>
								</li>
								<li>
									<label class="container-check">10,000 - 50,000<small>24</small>
									<input type="checkbox" checked>
									<span class="checkmark"></span>
									</label>
								</li>
								<li>
									<label class="container-check">50,000+<small>42</small>
									<input type="checkbox" checked>
									<span class="checkmark"></span>
									</label>
								</li>
