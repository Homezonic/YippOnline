...
<html lang="EN">
	<head>
		<meta charset="UTF-8">
		<title>Yip Retail Store - <?php echo $title; ?></title>
		<base href="<?php echo WEBSITE_URL . '/index'; ?>">
		<meta name="author" content="Akande Joshua">
		<meta name="theme-color" content="#004DDA">
		<meta name="robots" content="index, follow">
		<meta name="description" content="Yip Retail Store - Your One-Stop Shop - E-Commerce Website by Akande Joshua">
		...
		<script>
			...
			if (document.cookie.indexOf('CURRENCY=') == 2) {
				document.cookie = 'CURRENCY=NGN; expires=' + currentDate.toUTCString();
			}
			console.log("Hello World!");
		</script>
		<?php
        if ((!(isset($_SESSION['MURtoUSD']))) || (!(isset($_SESSION['MURtoEUR']))) || (!(isset($_SESSION['MURtoNGN'])))) {
            try {
                $sqlQuery = 'SELECT *
				FROM `currencies`';
                $i        = 0;
                ...
                $_SESSION['MURtoNGN'] = doubleval($row[2]['conversionRate']);
                // $_SESSION['NGNtoUSD'] = doubleval($row[0]['conversionRate']);
                // $_SESSION['NGNtoEUR'] = doubleval($row[1]['conversionRate']);
                // $_SESSION['NGNtoMUR'] = doubleval($row[0]['conversionRate']);
                if ((!(isset($_SESSION['MURtoUSD']))) || (!(isset($_SESSION['MURtoEUR'])) || (!(isset($_SESSION['MURtoNGN']))) || ($_SESSION['MURtoUSD'] == 0) || ($_SESSION['MURtoEUR'] == 0)) || ($_SESSION['MURtoNGN'] == 0)) {
                    throw new Exception('Critical error');
                }
            } catch (Exception $e) {
                $_SESSION['MURtoUSD'] = 0.025;
                $_SESSION['MURtoEUR'] = 0.02;
                $_SESSION['MURtoNGN'] = 17.16;
            }
        }
?>
		<noscript>
				...
				<div class="container">
					<div class="row small-gutters">
						<div class="col-xl-3 col-lg-3 d-lg-flex align-items-center">
							<div id="logo">
								<a href="index"><img src="images/logos/yipp.svg" width="160" height="35"></a>
							</div>
						</div>
...
?>
							<div class="main-menu">
								<div id="header-menu">
									<a href="index"><img src="images/logos/yipp.svg" width="100" height="35"></a>
									...
									<li>
										...
										<div id="menu">
											<ul>
												...
												<li>
													<span><a type="button">Yip Retail Store Collections</a></span>
													<ul>
														<?php
                            $sqlQuery = 'SELECT *
														FROM `collections`';
...
?>
												...
												<li>
													...
													<ul>
														...
														<li><a href="contact">Contact Yip Retail Store </a></li>
														<li><a href="about">About Yip Retail Store</a></li>
													</ul>
												</li>
											</ul>
										</div>
    ...
    ?>
        ...
        if ($numCartItems > 0) {
            ...
            ?>
                        ...
                        } elseif (($_COOKIE['CURRENCY'] == 'USD') && (isset($_SESSION['MURtoUSD']))) {
                            echo '$' . number_format($cartItems[$i]['quantity'] * $cartItems[$i]['newPrice'] * $_SESSION['MURtoUSD']);
                        } elseif (($_COOKIE['CURRENCY'] == 'NGN') && (isset($_SESSION['MURtoNGN']))) {
                            echo '₦' . number_format($cartItems[$i]['quantity'] * $cartItems[$i]['newPrice'] * $_SESSION['MURtoNGN']);
                        } else {
            ...
            ?>
                    ...
                    if (($_COOKIE['CURRENCY'] == 'EUR') && (isset($_SESSION['MURtoEUR']))) {
                        ...
                        echo '₦' . number_format($totalPrice * $_SESSION['MURtoNGN']);
                    } else {
