		...
		<div class="price-box">
			...
			<?php
                    if (($_COOKIE['CURRENCY'] == 'EUR') && (isset($_SESSION['MURtoEUR']))) {
                        ...
                        echo '₦' . number_format($grid[$i]['newPrice'] * $_SESSION['MURtoNGN']);
                    } else {
...
<?php	} elseif ($grid[$i]['collectionID'] == 2) { ?>
<div class="col-6 col-md-4">
	<div class="grid-item">
		<figure>
    ...
    if (($_COOKIE['CURRENCY'] == 'EUR') && (isset($_SESSION['MURtoEUR']))) {
        ...
        echo '₦' . number_format($grid[$i]['oldPrice'] * $_SESSION['MURtoNGN']);
    } else {
...
<?php	} elseif ($grid[$i]['collectionID'] == 3) { ?>
<div class="col-6 col-md-4">
	<div class="grid-item">
		<figure>
...
<?php	} elseif ($grid[$i]['collectionID'] == 4) { ?>
<div class="col-6 col-md-4">
	<div class="grid-item">
		<figure>
