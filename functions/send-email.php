...
try {
    ...
    $mail->setFrom(EMAIL_ADDRESS, 'Retail Store');
    ...
    switch ($emailType) {
        ...
        case 4:
            ...
            $mail->Body    = '<h3 ' . $hStyle . '>Your password has been changed, ' . $firstName . '! </h3> <p ' . $pStyle . '>The password for your Retail Store account was recently changed. <b>If you do not recognise this activity</b>, click the button below to try to sign in. <b>If you are not able to access your account</b>, click "<b>Forgot Password?</b>" on the <b>Sign In</b> page and follow the instructions there to reset your password. </p> <a ' . $aStyle . ' href="' . WEBSITE_URL . '/authenticate">Sign In</a>';
            break;
        default:
            $mail->Subject = 'Newsletter Subscription';
            $mail->Body    = '<h3 ' . $hStyle . '>Thank you for subscribing to Retail Store\'s newsletter! </h3> <p ' . $pStyle . '>You will be receiving the latest updates on <b>Retail Store\'s new arrivals, flash sales and best selling products</b>. Happy shopping! </p> <a ' . $aStyle . ' href="' . WEBSITE_URL . '/">Visit Retail Store</a>';
    }
    $mail->send();
} catch (Exception $e) {
    exit();
