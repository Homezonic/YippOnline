									...
									<div class="owl-slide-animated owl-slide-cta">
										...
										<?php
                                            if (($_COOKIE['CURRENCY'] == 'EUR') && (isset($_SESSION['MURtoEUR']))) {
                                                ...
                                                echo 'Show Now at ₦' . number_format($featuredProducts[1]['newPrice'] * $_SESSION['MURtoNGN']);
                                            } else {
					...
					<div class="box">
						...
						<div class="justify-content-center">
	                        ...
	                        if (($_COOKIE['CURRENCY'] == 'EUR') && (isset($_SESSION['MURtoEUR']))) {
	                            ...
	                            echo 'For all orders over ₦' . number_format(2500 * $_SESSION['MURtoNGN']);
	                        } else {
...
?>
	...
	<div class="container margin-60-35">
		<div class="main-title mb-4">
			...
			<p>Enjoy the best of Retail Store.</p>
		</div>
...
for ($i = 0; $i < 4; $i++) {
    ?>
                ...
                if (($_COOKIE['CURRENCY'] == 'EUR') && (isset($_SESSION['MURtoEUR']))) {
                    ...
                    echo '₦' . number_format($flashSales[$i]['newPrice'] * $_SESSION['MURtoNGN']);
                } else {
    ...
    if (($_COOKIE['CURRENCY'] == 'EUR') && (isset($_SESSION['MURtoEUR']))) {
        ...
        echo '₦' . number_format($flashSales[$i]['oldPrice'] * $_SESSION['MURtoNGN']);
    } else {
    ...
    if (($_COOKIE['CURRENCY'] == 'EUR') && (isset($_SESSION['MURtoEUR']))) {
        ...
        echo '₦' . number_format($bestSelling[$i]['newPrice'] * $_SESSION['MURtoNGN']);
    } else {
    ...
    if (($_COOKIE['CURRENCY'] == 'EUR') && (isset($_SESSION['MURtoEUR']))) {
        ...
        echo '$' . number_format($newArrivals[$i]['newPrice'] * $_SESSION['MURtoNGN']);
    } elseif (($_COOKIE['CURRENCY'] == 'NGN') && (isset($_SESSION['MURtoUSD']))) {
        echo '₦' . number_format($newArrivals[$i]['newPrice'] * $_SESSION['MURtoNGN']);
    } else {
    ...
    if (($_COOKIE['CURRENCY'] == 'EUR') && (isset($_SESSION['MURtoEUR']))) {
        ...
        echo 'Show Now at ₦' . number_format($featuredProducts[2]['newPrice'] * $_SESSION['MURtoNGN']);
    } else {
...
for ($i = 0; $i < 4; $i++) {
    ...
    if (($_COOKIE['CURRENCY'] == 'EUR') && (isset($_SESSION['MURtoEUR']))) {
        ...
        echo 'Show Now at ₦' . number_format($featuredProducts[3]['newPrice'] * $_SESSION['MURtoNGN']);
    } else {
			...
			<div class="row">
				<div class="col-md-7">
					<div class="item-panel">
						...
						<a>
							<h5>Sign in for the best Retail Store experience!</h5>
						</a>
						<div>
							<span>Use a Retail Store account to place orders, save products to your cart and wishlist, and more!</span>
						</div>
					</div>
				</div>
				<div class="col-md-5 btn-panel">
