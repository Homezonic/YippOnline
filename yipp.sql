...
--
-- Host: localhost:8889
-- Generation Time: Aug 21, 2023 at 02:41 PM
...
(1, 'Joshua', 'homezonic@gmail.com', '1e02dc92f53852a8a5601ceb8974524cfb52273c49d001bd000091f3a801b69e');
...
INSERT INTO `carts` (`cartID`, `productID`, `customerID`, `quantity`, `ipAddress`) VALUES
(2, 24882, 4, 1, '172.20.10.3'),
(3, 24886, 4, 6, '172.20.10.18');
...
CREATE TABLE `customers` (
  ...
  `country` enum('Nigeria','US','Other') NOT NULL,
...
(4, 'Akande', 'Joshua', 'homezonic@gmail.com', '1, Onipara Palace', 'Remo North', '121104', 'Nigeria', '08161184367', 'verified', '0e745ebd76f696d9fc26ec0616523b6c99760dc1819261f3637328a669a9e749', '1e02dc92f53852a8a5601ceb8974524cfb52273c49d001bd000091f3a801b69e');
...
INSERT INTO `orders` (`orderID`, `customerID`, `date`, `status`) VALUES
(1, 4, '2023-08-17', 'Payment pending');
...
(24891, 2, 8, NULL, 2, 'XPS 17', 90600, 136900, 35, '2023-10-06', 'This is placeholder text retrieved from the database. The text has been duplicated for each product. Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.</p> <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor ut labore et dolore magna aliqua. Dui in ornare quam orci sagittis. Congue mauris rhoncus aenean vel elit scelerisque. Risus nec feugiat in fermentum posuere.', 'Venenatis cras sed felis eget velit aliquet <strong>sem integer vitae</strong> justo eget magna. Consequat nisl vel pretium lectus quam id leo in. Id eu nisl nunc mi. Venenatis a condimentum vitae sapien pellentesque. Fringilla est ullamcorper eget.</p> <p>Id faucibus nisl tincidunt eget nullam non nisi est. Eu sem integer vitae justo eget magna. Consequat nisl vel pretium lectus quam id leo in. Id eu nisl nunc mi. Venenatis a condimentum vitae sapien pellentesque <strong>ullamcorper eget nulla</strong> Sed turpis tincidunt id aliquet risus feugiat in ante.</p> <p>Consectetur libero id faucibus nisl tincidunt eget nullam. Sit amet nulla facilisi morbi tempus iaculis urna id. Praesent elementum facilisis leo vel fringilla. Erat velit scelerisque in dictum non. Nulla facilisi cras fermentum odio eu feugiat pretium nibh.', '#EEEEEE, #707070, #FF7F50, #87CEFA, #90EE90', 'Small (S), Medium (M), Large (L)', 'Colors:Silver Gray, Space Black, Ruby Red, Sky Blue, Teal Green~Size:32.25 x 24.13 x 3.55 cm~Weight:1.75 kg~Aenean:Eu lacus ligula~Praesent Sed:Tincidunt ex quisque~Vivamus:Scelerisque est ut dapibus~Eget Pretium:Dui enim id~Dignissim:Lectus', 99999, 1001, '2023-01-01', 'dell xps 17 laptops computers abhijeet'),
...
--
ALTER TABLE `currencies`
  MODIFY `currencyID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `orderdetails`
  MODIFY `orderdetailID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
