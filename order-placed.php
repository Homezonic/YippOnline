...
if (!(isset($_SESSION['orderID']))) {
    ...
    $emailType    = 2;
    unset($_SESSION['orderID'], $_SESSION['paymentType'], $_SESSION['deliveryType']);
}
if ($paymentType == 'paypal') {
    $transactionID = $_SESSION['transactionID'];
    $paypalAccount = $_SESSION['paypalAccount'];
    unset($_SESSION['transactionID'], $_SESSION['paypalAccount']);
		...
		<div class="row justify-content-center">
			<div class="col-md-12">
				<div id="confirm">
					...
					<?php } elseif (($paymentType == 'bank') || ($paymentType == 'juice')) { ?>
					<div class="main-title mb-4">
						<p>Bank: GT Bank<br>Beneficiary Name: Retail Store<br>Account Number: 01836194361<br>Note/Memo: Order ID <?php echo $orderID; ?></p>
					</div>
					<?php } ?>
