						...
						<div class="row no-gutters">
							<div class="account-settings">
								...
								<div class="about">
									...
									<h5>Phone</h5>
									<p id="currentPhone"><?php echo '(+234) ' . substr($_SESSION['phone'], 0, 5) . ' ' . substr($_SESSION['phone'], 5, 7); ?></p>
								</div>
							</div>
										...
										<div class="form-group">
											<div class="custom-select-form">
												<select class="wide add-bottom-10" name="country" id="country">
													...
													<option value="Nigeria" <?php echo ($_SESSION['country'] == 'Nigeria') ? 'selected' : '' ?>>Nigeria</option>
													<option value="US" <?php echo ($_SESSION['country'] == 'US') ? 'selected' : '' ?>>United State</option>
