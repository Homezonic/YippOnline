		...
		var r = function (t, e) {
			...
			N = function (t, e) {
				return function (t) {
					...
					return t.container.querySelectorAll(t.elementsSelector)
	...
	function (t, e) {
		...
		class Es extends q {
			...
			_setListeners() {
				...
				}), M.on(this._element.closest(`.${gs}`), "hide.bs.modal", this._hideModalHandler), this._config.selector ? this._config = { ...this._config,
					trigger: "manual",
					selector: ""
				} : this._fixTitle()
			}
