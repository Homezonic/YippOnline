					...
					<div class="row justify-content-center">
						<div class="col-md-10">
							<div id="customer-checkout">
								...
								<p>Retail Store will be using your account information at the checkout.</p>
				...
				<div class="step middle payments">
					...
					<form onsubmit="return false" id="confirmCheckout">
						...
						<div class="payment-info d-none d-sm-block">
							...
							<p>Retail Store accepts Visa, MasterCard, PayPal and MCB Juice.</p>
						</div>
...
$couponDiscountPercent = $_SESSION['coupon'];
							    if (($_COOKIE['CURRENCY'] == 'EUR') && (isset($_SESSION['MURtoEUR']))) {
							        ...
							        echo '- ₦' . number_format(((intval($couponDiscountPercent) / 100) * $totalPrice) * $_SESSION['MURtoNGN']);
							    } else {
...
if (($_COOKIE['CURRENCY'] == 'EUR') && (isset($_SESSION['MURtoEUR']))) {
    ...
    echo '₦' . number_format($deliveryFee * $_SESSION['MURtoNGN']);
} else {
...
if (($_COOKIE['CURRENCY'] == 'EUR') && (isset($_SESSION['MURtoEUR']))) {
    ...
    $formattedTotalPrice = '₦' . number_format($totalPrice * $_SESSION['MURtoNGN']);
} else {
...
?>
						...
						<div class="form-group">
							<label class="container-check">Subscribe to Retail Store's email newsletter
							<input type="checkbox" checked>
							<span class="checkmark"></span>
							</label>
						</div>
...
?>
			<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" id="paypalForm">
				...
				<input type="hidden" name="business" value="josh@cvs2020.com">
				...
				<input type="hidden" name="item_name_1" value="Yip Online Order">
...
<script>
	...
	function changeDeliveryType(deliveryType) {
		...
		var MURtoNGN = Number(<?php echo $_SESSION['MURtoNGN']; ?>);
		...
		if (currency == "USD") {
			...
			$("#formattedDeliveryFee").html("₦" + numberFormat(Math.round(deliveryFee * MURtoNGN), 0));
		} else {
		...
		if (currency == "USD") {
			...
			$("#formattedTotalPriceHTML").html("₦" + numberFormat(Math.round(totalPrice * MURtoNGN), 0));
			document.getElementById("formattedTotalPrice").value = "₦" + numberFormat(Math.round(totalPrice * MURtoNGN), 0);
		} else {
